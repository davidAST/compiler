...
public class PmmParser extends Parser {
	...
	public static final int
		...
		RULE_expression = 7, RULE_statement = 8, RULE_statementSimple = 9, RULE_block = 10, 
		RULE_type = 11, RULE_recordField = 12;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "variables", "varDefinition", "params", "functionDefinition", 
			"mainDefinition", "returnType", "expression", "statement", "statementSimple", 
	...
	public final FunctionDefinitionContext functionDefinition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 33111513595936L) != 0)) {
				{
				{
				setState(100);
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 5:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 32985348931616L) != 0)) {
					{
					setState(167);
	...
	public static class StatementContext extends ParserRuleContext {
		...
		public Token ID;
		public ExpressionContext exp1;
		public StatementSimpleContext st1;
		public StatementSimpleContext st2;
		public List<ExpressionContext> expression() {
			return getRuleContexts(ExpressionContext.class);
		}
		public ExpressionContext expression(int i) {
		...
		public TerminalNode ID() { return getToken(PmmParser.ID, 0); }
		public List<StatementSimpleContext> statementSimple() {
			return getRuleContexts(StatementSimpleContext.class);
		}
		public StatementSimpleContext statementSimple(int i) {
			return getRuleContext(StatementSimpleContext.class,i);
		}
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 9:
				...
				match(T__4);
				setState(307);
				((StatementContext)_localctx).st1 = statementSimple();
				setState(308);
				match(T__2);
				setState(309);
				((StatementContext)_localctx).exp1 = expression(0);
				...
				match(T__2);
				setState(311);
				((StatementContext)_localctx).st2 = statementSimple();
				setState(312);
				match(T__5);
				setState(313);
				((StatementContext)_localctx).b1 = block();

				                    Statement init = !((StatementContext)_localctx).st1.ast.isEmpty() ? ((StatementContext)_localctx).st1.ast.get(0) : null;
				                    Statement update = !((StatementContext)_localctx).st2.ast.isEmpty() ? ((StatementContext)_localctx).st2.ast.get(0) : null;

				                    _localctx.ast.add(new For(((StatementContext)_localctx).exp1.ast.getLine(), ((StatementContext)_localctx).exp1.ast.getColumn(), ((StatementContext)_localctx).exp1.ast, ((StatementContext)_localctx).b1.ast, init, update));
	...
	@SuppressWarnings("CheckReturnValue")
	public static class StatementSimpleContext extends ParserRuleContext {
		public List<Statement> ast = new ArrayList<>();
		public List<Statement> statements = new ArrayList<>();
		public List<Expression> expressions = new ArrayList<>();
		public ExpressionContext exp;
		...
		public StatementSimpleContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_statementSimple; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PmmListener ) ((PmmListener)listener).enterStatementSimple(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PmmListener ) ((PmmListener)listener).exitStatementSimple(this);
		}
	}

	public final StatementSimpleContext statementSimple() throws RecognitionException {
		StatementSimpleContext _localctx = new StatementSimpleContext(_ctx, getState());
		enterRule(_localctx, 18, RULE_statementSimple);
		int _la;
		try {
			setState(364);
			_errHandler.sync(this);
			...
			case 1:
				...
				match(T__28);
				setState(319);
				((StatementSimpleContext)_localctx).exp = expression(0);
				_localctx.ast.add(new Print(((StatementSimpleContext)_localctx).exp.ast.getLine(), ((StatementSimpleContext)_localctx).exp.ast.getColumn(), ((StatementSimpleContext)_localctx).exp.ast));
				setState(327);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==T__0) {
					...
					match(T__0);
					setState(322);
					((StatementSimpleContext)_localctx).exp2 = expression(0);
					_localctx.ast.add(new Print(((StatementSimpleContext)_localctx).exp2.ast.getLine(), ((StatementSimpleContext)_localctx).exp2.ast.getColumn(), ((StatementSimpleContext)_localctx).exp2.ast)); 
					}
					}
					setState(329);
					_errHandler.sync(this);
			...
			case 2:
				...
				setState(331);
				((StatementSimpleContext)_localctx).exp = expression(0);
				_localctx.ast.add(new Read(((StatementSimpleContext)_localctx).exp.ast.getLine(), ((StatementSimpleContext)_localctx).exp.ast.getColumn(), ((StatementSimpleContext)_localctx).exp.ast)); 
				setState(339);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==T__0) {
					...
					setState(334);
					((StatementSimpleContext)_localctx).exp2 = expression(0);
					_localctx.ast.add(new Read(((StatementSimpleContext)_localctx).exp2.ast.getLine(), ((StatementSimpleContext)_localctx).exp2.ast.getColumn(), ((StatementSimpleContext)_localctx).exp2.ast)); 
					}
					}
					setState(341);
					_errHandler.sync(this);
			...
			case 3:
				...
				{
				setState(342);
				((StatementSimpleContext)_localctx).left = expression(0);
				setState(343);
				match(T__30);
				setState(344);
				((StatementSimpleContext)_localctx).right = expression(0);
				_localctx.ast.add(new Assignment(((StatementSimpleContext)_localctx).left.ast.getLine(), ((StatementSimpleContext)_localctx).left.ast.getColumn(), ((StatementSimpleContext)_localctx).left.ast, ((StatementSimpleContext)_localctx).right.ast)); 
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				...
				match(T__1);
				setState(350);
				((StatementSimpleContext)_localctx).b1 = block();
				setState(351);
				match(T__32);
				setState(352);
				match(T__1);
				setState(353);
				((StatementSimpleContext)_localctx).b2 = block();
				_localctx.ast.add(new IfElse(((StatementSimpleContext)_localctx).exp.ast.getLine(), ((StatementSimpleContext)_localctx).exp.ast.getColumn(), ((StatementSimpleContext)_localctx).b1.ast, ((StatementSimpleContext)_localctx).exp.ast, ((StatementSimpleContext)_localctx).b2.ast)); 
				}
				break;
			case 5:
				enterOuterAlt(_localctx, 5);
				...
				setState(359);
				((StatementSimpleContext)_localctx).b1 = block();
				_localctx.ast.add(new IfElse(((StatementSimpleContext)_localctx).exp.ast.getLine(), ((StatementSimpleContext)_localctx).exp.ast.getColumn(), ((StatementSimpleContext)_localctx).b1.ast, ((StatementSimpleContext)_localctx).exp.ast)); 
				}
				break;
			case 6:
				enterOuterAlt(_localctx, 6);
