...
public class PmmParser extends Parser {
	...
	public static final int
		...
		T__38=39, T__39=40, T__40=41, T__41=42, ID=43, INT_CONSTANT=44, REAL_CONSTANT=45, 
		CHAR_CONSTANT=46, SINGLE_LINE_COMMENT=47, MULTI_LINE_COMMENT=48, WS=49;
	public static final int
		...
		RULE_expression = 7, RULE_statement = 8, RULE_cases = 9, RULE_block = 10, 
		RULE_type = 11, RULE_recordField = 12;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "variables", "varDefinition", "params", "functionDefinition", 
			"mainDefinition", "returnType", "expression", "statement", "cases", "block", 
			"type", "recordField"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'switch'", "'case'", "'break'", "'char'", "'int'", "'double'", "'struct'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, "ID", "INT_CONSTANT", "REAL_CONSTANT", 
	...
	public final FunctionDefinitionContext functionDefinition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 132067560095776L) != 0)) {
				{
				{
				setState(100);
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 5:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 131941395431456L) != 0)) {
					{
					setState(167);
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 9:
				...
				setState(309);
				match(T__8);
				_localctx.ast.add(new Switch(((StatementContext)_localctx).exp.ast.getLine(),
				                                 ((StatementContext)_localctx).exp.ast.getColumn(),
				                                 ((StatementContext)_localctx).exp.ast,
				                                 ((StatementContext)_localctx).cases.ast));
				}
				break;
			}
		}
	...
	public static class CasesContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PmmListener ) ((PmmListener)listener).enterCases(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PmmListener ) ((PmmListener)listener).exitCases(this);
		}
	}
	...
	public final CasesContext cases() throws RecognitionException {
		...
		try {
			...
			while (_la==T__36) {
				...
				match(T__36);
				setState(315);
				((CasesContext)_localctx).exp = expression(0);
				setState(316);
				match(T__1);
				...
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 132067560095776L) != 0)) {
					...
					{
					setState(318);
					((CasesContext)_localctx).st = statement();
					statements.addAll(((CasesContext)_localctx).st.ast);
					}
					}
					setState(325);
					_errHandler.sync(this);
				...
				setState(327);
				match(T__2);
				_localctx.ast.add(new Case(((CasesContext)_localctx).exp.ast.getLine(),
				                               ((CasesContext)_localctx).exp.ast.getColumn(),
				                               ((CasesContext)_localctx).exp.ast,
				                               statements));
				}
				}
				setState(334);
