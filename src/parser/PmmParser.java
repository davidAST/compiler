...
public class PmmParser extends Parser {
	...
	public static final int
		...
		T__38=39, T__39=40, T__40=41, ID=42, INT_CONSTANT=43, REAL_CONSTANT=44, 
		CHAR_CONSTANT=45, SINGLE_LINE_COMMENT=46, MULTI_LINE_COMMENT=47, WS=48;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, "ID", "INT_CONSTANT", "REAL_CONSTANT", 
	...
	public final FunctionDefinitionContext functionDefinition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 66200478515232L) != 0)) {
				{
				{
				setState(98);
	...
	public static class ExpressionContext extends ParserRuleContext {
		...
		public ExpressionContext middle2;
		public ExpressionContext right2;
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				match(T__5);
				setState(152);
				((ExpressionContext)_localctx).exp = expression(14);
			...
			case 5:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 65970697764896L) != 0)) {
					{
					setState(165);
				...
				if ( _alt==1 ) {
					...
					case 4:
						...
						((ExpressionContext)_localctx).ast =  new Logical(
						                              ...
						                              new Comparison(((ExpressionContext)_localctx).left.ast.getLine(), ((ExpressionContext)_localctx).left.ast.getColumn(), ((ExpressionContext)_localctx).left.ast, ((ExpressionContext)_localctx).middle.ast, "<"),
						                              new Comparison(((ExpressionContext)_localctx).left.ast.getLine(), ((ExpressionContext)_localctx).left.ast.getColumn(), ((ExpressionContext)_localctx).middle.ast, ((ExpressionContext)_localctx).right.ast, "<"),
						                              "&&");
						}
						break;
					case 5:
						...
						match(T__27);
						setState(214);
						((ExpressionContext)_localctx).middle2 = expression(0);
						setState(215);
						match(T__27);
						setState(216);
						((ExpressionContext)_localctx).right2 = expression(8);
						((ExpressionContext)_localctx).ast =  new Logical(
						                              ((ExpressionContext)_localctx).left2.ast.getLine(),
						                              ((ExpressionContext)_localctx).left2.ast.getColumn(),
						                              new Comparison(((ExpressionContext)_localctx).left2.ast.getLine(), ((ExpressionContext)_localctx).left2.ast.getColumn(), ((ExpressionContext)_localctx).left2.ast, ((ExpressionContext)_localctx).middle2.ast, ">"),
						                              new Comparison(((ExpressionContext)_localctx).left2.ast.getLine(), ((ExpressionContext)_localctx).left2.ast.getColumn(), ((ExpressionContext)_localctx).middle2.ast, ((ExpressionContext)_localctx).right2.ast, ">"),
						                              "&&");
						}
						break;
					case 6:
