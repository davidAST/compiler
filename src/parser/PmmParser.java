...
public class PmmParser extends Parser {
	...
	public static final int
		RULE_program = 0, RULE_variables = 1, RULE_varDefinition = 2, RULE_arrayInitializer = 3, 
		RULE_params = 4, RULE_functionDefinition = 5, RULE_mainDefinition = 6, 
		RULE_returnType = 7, RULE_expression = 8, RULE_statement = 9, RULE_block = 10, 
		RULE_type = 11, RULE_recordField = 12;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "variables", "varDefinition", "arrayInitializer", "params", 
			"functionDefinition", "mainDefinition", "returnType", "expression", "statement", 
	...
	public final VarDefinitionContext varDefinition() throws RecognitionException {
		...
		try {
			...
			if (_la==T__2) {
				...
				match(T__2);
				setState(68);
				((VarDefinitionContext)_localctx).init = arrayInitializer();
				}
			}
			...
			match(T__3);
			            ...
			            for (Token t : _localctx.tokens) {
			                ...
			                VarDefinition var = new VarDefinition(
			                    ...
			                    ((VarDefinitionContext)_localctx).init != null ? ((VarDefinitionContext)_localctx).init.ast : null
			                );
	...
	public static class ArrayInitializerContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof PmmListener ) ((PmmListener)listener).enterArrayInitializer(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof PmmListener ) ((PmmListener)listener).exitArrayInitializer(this);
		}
	}
	...
	public final ArrayInitializerContext arrayInitializer() throws RecognitionException {
		...
		try {
			...
			match(T__4);
			setState(75);
			((ArrayInitializerContext)_localctx).exp1 = expression(0);
			_localctx.ast.add(((ArrayInitializerContext)_localctx).exp1.ast);
			setState(83);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==T__0) {
				...
				match(T__0);
				setState(78);
				((ArrayInitializerContext)_localctx).exp2 = expression(0);
				_localctx.ast.add(((ArrayInitializerContext)_localctx).exp2.ast);
				}
				}
				setState(85);
				_errHandler.sync(this);
	...
	public final FunctionDefinitionContext functionDefinition() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 16551730413824L) != 0)) {
				{
				{
				setState(118);
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 5:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 16492674613504L) != 0)) {
					{
					setState(185);
	...
	public static final String _serializedATN =
		...
		"\b\f\b\u00c3\t\b\u0003\b\u00c5\b\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001"+
		"\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0003\b\u00d1\b\b\u0001\b\u0001"+
		"\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001"+
		"\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001"+
		"\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001\b\u0001"+
		"\b\u0001\b\u0005\b\u00f1\b\b\n\b\f\b\u00f4\t\b\u0001\t\u0001\t\u0001\t"+
